# Consuming Healers Inc in web apps

Read `artifacts/healers-inc/docs/AGENTS.md` first. This guide covers
...
`artifacts/healers-inc/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/healers-inc/styles.css";
```
...
`node_modules/@workspace/healers-inc/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/healers-inc/hooks/use-toast";
```
...
`@workspace/healers-inc/components/ui/button`. Run the app's typecheck
