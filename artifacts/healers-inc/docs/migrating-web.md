# Migrating web UI to Healers Inc

Read `artifacts/healers-inc/docs/AGENTS.md` and
`artifacts/healers-inc/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/healers-inc/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/healers-inc/lib/utils`
- `@/hooks/use-toast` → `@workspace/healers-inc/hooks/use-toast`
