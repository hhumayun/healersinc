  ...
  return (
    <div className="space-y-8 rounded-xl border bg-card p-6 text-card-foreground">
      ...
      <section className="space-y-4 border-t pt-6">
        <div>
          <h2 className="font-semibold">Color usage</h2>
          <p className="text-sm text-muted-foreground">
            Patterns observed across the Healers Inc product screens.
          </p>
        </div>
        <Guidelines
          items={[
            {
              kind: 'do',
              text: 'Use the orange primary for the main call to action on a view — Sign In, Chat Now, Send Booking Request — and for active pills and selected pagination.',
            },
            {
              kind: 'do',
              text: 'Use the blue accent for text links, utility actions like Search, checkboxes, and selected navigation tiles.',
            },
            {
              kind: 'do',
              text: 'Lay content on white cards over the soft gray background; keep body text in the near-black foreground and labels in muted gray.',
            },
            {
              kind: 'dont',
              text: 'Compete with the primary — one orange call to action per view; supporting actions stay outline or ghost.',
            },
            {
              kind: 'dont',
              text: 'Set long body copy in orange or blue; brand colors mark actions and states, not paragraphs.',
            },
          ]}
        />
      </section>
