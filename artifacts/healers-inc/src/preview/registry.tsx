...
export const DESIGN_SYSTEM = {
  title: 'Healers Inc Design System',
  description:
    'The visual language of Healers Inc — a wellness platform connecting people with practitioners and services. Warm orange leads every primary action, peach softens supporting surfaces, and utility blue handles links and selection.',
} as const;
...
const LogoPage = lazyPage(() =>
  import('./brand').then(({ LogoPage }) => LogoPage),
);
    ...
    entries: [
      {
        id: 'brand-logo',
        name: 'Logo',
        description: 'The Healers Inc mark and how to place it.',
        Page: LogoPage,
      },
    ],
  },
